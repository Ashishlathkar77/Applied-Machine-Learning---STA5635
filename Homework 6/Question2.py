...
def load_data(train_data_path, train_labels_path, valid_data_path, valid_labels_path):
    ...
    X_test = np.genfromtxt(valid_data_path, delimiter=',')
...
if __name__ == "__main__":
    ...
    train_data_path = '/path/to/dexter_train.csv'  # Update with your actual file paths
    train_labels_path = '/path/to/dexter_train.labels'
    valid_data_path = '/path/to/dexter_valid.csv'
    valid_labels_path = '/path/to/dexter_valid.labels'
